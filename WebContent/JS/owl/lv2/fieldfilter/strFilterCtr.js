 ...
 * 整理lampig 
 * 使用方法：
 * var fltr = f.fun("100px","DevNo_filter", '../JS/owl/control/fieldfilter/filter.png', fun1);
 * 参数说明：
 * 1."100px" 控件的input的宽度。
 * 1."DevNo_filter"：过滤器的唯一标示符号，为字符串， 用于区别于别的控件。
 * 2.'../JS/owl/control/fieldfilter/filter.png'：过滤器的过滤按钮图片
 * 3.fun1:过滤时调用的函数，该函数接收{controlID: “sss”, valType:"AB", value: '123'}这样的一个对象，其中分别是过滤器的标识符，过滤规则，过滤值
 * 另外：
...
define(function(require, exports, module){
	...
	var func = function(inputWidth, controlID, imgbtnsrc, backfun){
		...
		var li_hover_css = {'background-color':'#f7f7f7'};
		var li_out_css = {'background-color':'#ccc'};
